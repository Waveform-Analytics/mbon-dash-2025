    ...
    <div className="min-h-screen bg-background flex flex-col">
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex items-center mb-2">
                ...
                <div>
                  <div className="text-sm text-muted-foreground">Notebook 08</div>
                  <h1 className="text-3xl font-bold text-primary">Dolphin Intensity Conversion</h1>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">Interactive marimo notebook: Dolphin Intensity Conversion</p>
                </motion.div>
      ...
      >
        ...
        >
          ...
          <iframe
            ref={iframeRef}
            src="/analysis/notebooks/html/08_dolphin_intensity_conversion.html"
            className="w-full h-full border-0"
            title="Dolphin Intensity Conversion"

    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-primary mb-4">Data Prep</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Load all data streams and perform initial quality assessment</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Raw data summaries, temporal coverage plots, missing data visualization</p>
              </motion.div>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="container mx-auto px-4 py-4 flex-shrink-0">
        ...
        >
          ...
          <div className="mb-4">
            <h1 className="text-3xl font-bold text-primary mb-2">Community Pattern Detection</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">Interactive marimo notebook: Community Pattern Detection</p>
              </motion.div>
      ...
      >
        ...
        >
          <iframe
            src="/analysis/notebooks/html/06_community_pattern_detection.html"
            className="w-full h-full border-0"
            title="Community Pattern Detection"

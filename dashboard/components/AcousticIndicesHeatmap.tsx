...
const AcousticIndicesHeatmap: React.FC<AcousticIndicesHeatmapProps> = ({ className = '' }) => {
  ...
  useEffect(() => {
    ...
    const xAxis = d3.axisBottom(xScale)
      .tickFormat(d => {
        // Convert day of year back to date for the current year
    ...
    // Add X axis label
    svg.append('text')
      .attr('transform', `translate(${containerWidth / 2},${400 - 10})`)
    ...
    const legend = svg.append('g')
      .attr('transform', `translate(${containerWidth - legendWidth - 30},${20})`);
